...
# Write the function nondestructiveRemoveRepeats(L), which takes a list L
#  and nondestructively returns a new list in which any repeating elements in L are removed.
