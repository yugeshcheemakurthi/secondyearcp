...
public class TestJUnit {
   ...
   public void testCase1() {
      recursions_alternatingsum s = new recursions_alternatingsum();
      int[] arr1 = {5,3,8,4};
      int[] arr2 = {};
      int[] arr3 = {1,2,3,4};
      assertEquals("1.",  6, s.fun_recursions_alternatingsum(arr1));
      assertEquals("2.",  0, s.fun_recursions_alternatingsum(arr2));
      assertEquals("3.", -2, s.fun_recursions_alternatingsum(arr3));
   }
